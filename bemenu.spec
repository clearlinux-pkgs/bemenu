...
Source0  : https://github.com/Cloudef/bemenu/releases/download/0.6.10/bemenu-0.6.10.tar.gz
Source1  : https://github.com/Cloudef/bemenu/releases/download/0.6.10/bemenu-0.6.10.tar.gz.asc
...
%prep
%setup -q -n bemenu-0.6.10
cd %{_builddir}/bemenu-0.6.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657113837
...
cp %{_builddir}/bemenu-0.6.10/LICENSE-CLIENT %{buildroot}/usr/share/package-licenses/bemenu/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/bemenu-0.6.10/LICENSE-LIB %{buildroot}/usr/share/package-licenses/bemenu/f45ee1c765646813b442ca58de72e20a64a7ddba
%make_install
