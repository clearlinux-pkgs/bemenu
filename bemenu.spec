...
Version  : 0.6.14
Release  : 8
URL      : https://github.com/Cloudef/bemenu/releases/download/0.6.14/bemenu-0.6.14.tar.gz
Source0  : https://github.com/Cloudef/bemenu/releases/download/0.6.14/bemenu-0.6.14.tar.gz
Source1  : https://github.com/Cloudef/bemenu/releases/download/0.6.14/bemenu-0.6.14.tar.gz.asc
...
%prep
%setup -q -n bemenu-0.6.14
cd %{_builddir}/bemenu-0.6.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671203031
