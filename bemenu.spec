...
Version  : 0.6.13
Release  : 7
URL      : https://github.com/Cloudef/bemenu/releases/download/0.6.13/bemenu-0.6.13.tar.gz
Source0  : https://github.com/Cloudef/bemenu/releases/download/0.6.13/bemenu-0.6.13.tar.gz
Source1  : https://github.com/Cloudef/bemenu/releases/download/0.6.13/bemenu-0.6.13.tar.gz.asc
...
%prep
%setup -q -n bemenu-0.6.13
cd %{_builddir}/bemenu-0.6.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665494553
