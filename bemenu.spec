...
Source0  : https://github.com/Cloudef/bemenu/releases/download/0.6.16/bemenu-0.6.16.tar.gz
Source1  : https://github.com/Cloudef/bemenu/releases/download/0.6.16/bemenu-0.6.16.tar.gz.asc
...
%prep
%setup -q -n bemenu-0.6.16
cd %{_builddir}/bemenu-0.6.16
pushd ..
cp -a bemenu-0.6.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696516552
